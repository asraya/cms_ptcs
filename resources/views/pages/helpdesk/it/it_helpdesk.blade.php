...
@section('scripts')
    ...
    var table = $('.it_helpdesk').DataTable({
        ...
        columns: [
            {"data":"help_ticket"},
            // {"data":"help_type"},
            {data:  'help_type',name: 'tran_helpdesk.help_type', render: function ( data, type, row ) {
                var text = "";
                var label = "";
                if (data == 1){
            ...
            // {"data":"help_file"},
            {data:  'help_file',name: 'tran_helpdesk.help_file', render: function ( data, type, row ) {
                var text = "";
                var label = "";
                if (data == 1){
                text = "Check";
            ...
            {"data":"help_solvedate"},
            // {"data":"help_status"},
            {data:  'help_status',name: 'tran_helpdesk.help_status', render: function ( data, type, row ) {
                var text = "";
                var label = "";
                if (data == 0){
                text = "Waiting";
