    ...
    <div class="card card-custom">
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            <div class="card-title">
                ...
                <a href="/car_list" class="btn btn-danger font-weight-bolder">
                <span class="svg-icon svg-icon-md">
                  
                    <!--end::Svg Icon-->
                </span>List Car</a>
                &nbsp;
                <a href="/driver_list" class="btn btn-danger font-weight-bolder">
                  <span class="svg-icon svg-icon-md">
...
<script> 
    var table = $('.test').DataTable({
           processing: true,
           serverSide: true,
           ajax: "{{ route ('api.datatables_car_request') }}",
               columns: [
               {data: 'trip_purpose', name: 'tran_trip.trip_purpose'},
               {data: 'trip_name', name: 'tran_trip.trip_name'},
