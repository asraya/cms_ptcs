                        ...
                        <div style="width: 16.66%;border:1px solid rgb(243, 243, 243)" class="mb-4">
                            <div class="stationaryCard">
                                <div class="view overlay">
                                    <form action="{{url('/add_genreq/addstationary', $stationary->id_item)}}" method="POST">
                                        @csrf
                                        @if($stationary->qty == 0)
                                ...
                                <div class="card-body">
                                    <label class="card-text text-center font-weight-bold"
                                        ...
                                        {{ Str::words($stationary->name_stat,4) }} ({{$stationary->stock_item}}) </label>
                                    <p class="card-text text-center">Rp. {{ number_format($stationary->price_stat,2,',','.') }}
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div style="overflow-y:auto;min-height:53vh;max-height:53vh" class="mb-3">
                        <table class="table table-sm">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <form action="{{url('/transcation/removestationary',$item['rowId'])}}"
                                            method="POST">
                                            @csrf
